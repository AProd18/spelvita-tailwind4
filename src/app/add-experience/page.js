  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-[color:var(--color-dark-olive)] text-[color:var(--color-cornsilk)] py-2 rounded hover:bg-opacity-90 hover:bg-opacity-90 hover:bg-[color:var(--color-cornsilk-dark)] hover:text-[color:var(--color-dark-olive)] cursor-pointer transition-all duration-300"
        >
          Pošalji
        </button>
      </form>
